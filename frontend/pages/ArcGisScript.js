require([
    ...
    window.renderMap = function(groupedData) {
        ...
        function domRatingFormat(rating) {
            return `${rating}/5.0`;
        }
        ...
        for (let dorm of dormsArr) {
            ...
            const data = groupedData[dorm.name];
            const avgStar = averageStar(data);
            var attributes = {
                Name: dorm.name,  // The name of the
                Rating: domRatingFormat(avgStar),  // The owner of the
            };
